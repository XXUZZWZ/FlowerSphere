...
<body>
    ...
    <div class="container">
        <h1>BloomSphere</h1>
        <h2 style="text-align: center;">添加花卉</h2>
        
        <% if (request.getAttribute("errorMessage") != null) { %>
            <div class="message"><%= request.getAttribute("errorMessage") %></div>
        <% } %>
        
        <form action="${pageContext.request.contextPath}/flower/add" method="post">
            ...
            <div class="form-group">
                ...
                <select id="category" name="category" required>
                    ...
                    <option value="室内植物">室内植物</option>
                    <option value="室外植物">室外植物</option>
                    <option value="观赏花卉">观赏花卉</option>
